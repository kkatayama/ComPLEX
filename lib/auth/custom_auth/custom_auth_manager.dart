...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    musicAuthUserSubject.add(
      MusicAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MusicAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MusicAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MusicAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    musicAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
